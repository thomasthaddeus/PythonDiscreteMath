...
(3) Prompt the user for data points.
    ...
    Store the information before the comma into a string variable
    and the information after the comma into an integer.
    ...
    Store the integer components of the data points in a list of integers. (4 pts)
Ex:-----------------------------------------
...
(5) Output the information in a formatted table.
    ...
    Column 2 has a minimum field width value of 23. (3 pts)
Ex:------------------------------------------
            Number of Novels Authored
